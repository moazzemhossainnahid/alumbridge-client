                ...
                <div className="relative rounded-md">
                    ...
                    <div className="text-xl relative bg-gradient-to-r from-blue-700 to-transparent w-full h-full z-40 top-0 md:p-16 p-6 flex flex-col justify-between rounded-md ">
                        ...
                        <div className="md:mt-12 mt-20">
                            <Link to='/aboutus' smooth={true} duration={500} className="text-base cursor-pointer font-medium leading-4 text-indigo-700 bg-white sm:w-auto w-full rounded p-4 focus:outline-none hover:bg-gray-100 focus:ring-2 focus:ring-offset-2 focus:ring-white">Explore More</Link>
                        </div>
                    </div>
                </div>
            </div>
