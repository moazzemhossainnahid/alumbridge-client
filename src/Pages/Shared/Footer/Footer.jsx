      ...
      <div className="bg-black text-white w-4/4 m-0 py-10">
        <footer className="text-center lg:text-left bg-black text-white">
          ...
          <div className="mx-6 py-10 text-center md:text-left">
            <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className=" mx-auto">
                ...
                <p className='mb-4'>
                  <a href="/jobs" className=" text-white">Jobs</a>
                </p>
                <p className="mb-4">
              ...
              <div className=" mx-auto">
                ...
                <p className="mb-4">
                  <a href="#!" className=" text-white">Pilocy</a>
                </p>
                <p className="mb-4">
          ...
          <div className="text-center p-6 bg-black">
            ...
            <span onClick={() => navigate('/')} className=" text-white cursor-pointer font-semibold tracking-widest"> AlumBridge</span>
          </div>
        </footer>
      </div>
    </div>
