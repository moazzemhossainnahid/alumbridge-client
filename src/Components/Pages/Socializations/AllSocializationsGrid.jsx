      ...
      <div className="mx-2 lg:mb-0 mb-8">
        <div className="bg-white p-3">
          ...
          <div className="flex items-center justify-between px-4 pt-4">
            ...
            <h2 className="text-xs font-semibold">{socialization?.companyName}</h2>
            </div>
          </div>
          <div className="p-4">
            ...
            <div className="w-full mt-4">
              <div className="space-y-3">
                <p className="w-fit text-xs text-gray-600 px-2 bg-gray-200 py-1 font-semibold">
                  Position: <span className="font-normal">{socialization?.positionName}</span>
                </p>
                <p className="w-fit text-xs text-gray-600 px-2 bg-gray-200 py-1 font-semibold">
                  Vacancy: <span className="font-normal">{socialization?.vacancy}</span>
                </p>
              </div>
            </div>
          </div>
